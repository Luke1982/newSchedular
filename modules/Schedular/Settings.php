...
if(!is_admin($current_user)) {
	...
	$menu_array['SchedularSettings']['location']	= 'index.php?module=Schedular&action=SchedularSettings';
	$menu_array['SchedularSettings']['image_src']	= 'schedular_settings.png';
	$menu_array['SchedularSettings']['desc']		= 'Specific Schedular settings';
	$menu_array['SchedularSettings']['label']		= 'Schedular settings';
	...
	$smarty->display(vtlib_getModuleTemplate('Schedular','Settings.tpl'));
}
?>