...
<article class="slds-card schedular-relation" id="{if $template == 'true'}relation-template{else}relation-{$relation.schedular_relid}{/if}" {if $template == 'true'}style="display: none;"{/if}>
	<div class="slds-card__header slds-grid">
		...
		<div class="slds-no-flex">
			...
			<button class="slds-button slds-button_neutral schedular-relation__save">Save</button>
		</div>
	</div>
		...
		<div class="slds-form slds-form_horizontal">
			...
			<label class="slds-form-element__label" for="text-input-id-1">{$MOD.filter_fields}</label>
				<div class="slds-form-element__control">
					<input id="text-input-id-1" class="slds-input" placeholder="Enter comma separated search fields" type="text">
				</div>
			</div>
			<div class="slds-form-element">
			<label class="slds-form-element__label" for="text-input-id-1">{$MOD.return_fields}</label>
				<div class="slds-form-element__control">
					<input id="text-input-id-1" class="slds-input" placeholder="Enter comma separated return fields" type="text">
				</div>
			</div>
			<div class="slds-form-element">
			<label class="slds-form-element__label" for="text-input-id-1">{$MOD.include_relation_id}</label>
				<div class="slds-form-element__control">
					<input id="text-input-id-1" class="slds-input" placeholder="Enter relation ID you want to include in the search" type="text">
				</div>
			</div>
			<div class="slds-form-element">
			<label class="slds-form-element__label" for="text-input-id-1">{$MOD.relation_filterfield}</label>
				<div class="slds-form-element__control">
					<input id="text-input-id-1" class="slds-input" placeholder="Filter field for the included relation's CRM ID" type="text">
				</div>
			</div>
		</div>
	</div>
